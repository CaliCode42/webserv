...

{
    ...
    printf '0\r\n'
    printf '\r\n'
} | nc -q1 "$HOST" "$PORT" > "${CHUNKED_LIMIT_RESPONSE}" 2>/dev/null || true
...

{
    ...
    printf '\r\n'
} | nc -q1 "$HOST" "$PORT" > "${CHUNKED_TOO_LARGE_RESPONSE}" 2>/dev/null || true
...

{
    ...
    printf '100001\r\n'
} | nc -q1 "$HOST" "$PORT" > "${OVERSIZED_CHUNK_RESPONSE}" 2>/dev/null || true
