...
// static void	testCgiProcessInput()
// {
// 	std::cout << "===== CGI process input =====" << std::endl;

// 	CgiProcess			process;
// 	CgiProcess::envMap	env;
// 	const std::string	body = "Hello CGI POST";
...
// 	env["QUERY_STRING"] = "";
// 	env["SCRIPT_FILENAME"] = "www/cgi-bin/test_post.py";
// 	env["SCRIPT_NAME"] = "/cgi/test_post.py";
// 	env["SERVER_PROTOCOL"] = "HTTP/1.1";
...
// 	if (!process.start(
// 			"/usr/bin/python3",
// 			"www/cgi-bin/test_post.py",
// 			env,
// 			body))
// 	{
// 		std::cout << RED
// 				  << "[FAIL] could not start CGI POST process"
// 				  << RESET
// 				  << std::endl;
// 		return;
// 	}
...
// 		{
// 			std::cout << RED
// 					  << "[FAIL] CGI POST process did not finish before timeout"
// 					  << RESET
// 					  << std::endl;
// 			return;
// 		}
...
// 	{
// 		std::cout << RED
// 				  << "[FAIL] error while writing CGI input"
// 				  << RESET
// 				  << std::endl;
// 		return;
// 	}
...
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI POST process did not finish"
// 				  << RESET
// 				  << std::endl;
// 	}
...
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI stdin closed after body transmission"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI stdin is still open after body transmission"
// 				  << RESET
// 				  << std::endl;
// 	}
...
// 	if (output.find("Received: " + body) != std::string::npos)
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI received expected POST body"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI did not receive expected POST body"
// 				  << RESET
// 				  << std::endl;
...
// static void	testCgiProcessPartialInput()
// {
// 	std::cout << "===== CGI process partial input =====" << std::endl;
...
// 	env["REQUEST_METHOD"] = "POST";
// 	env["QUERY_STRING"] = "";
// 	env["SCRIPT_FILENAME"] = "www/cgi-bin/test_post_large.py";
// 	env["SCRIPT_NAME"] = "/cgi/test_post_large.py";
// 	env["SERVER_PROTOCOL"] = "HTTP/1.1";
// 	env["CONTENT_LENGTH"] = contentLength.str();
...
// 	if (!process.start(
// 			"/usr/bin/python3",
// 			"www/cgi-bin/test_post_large.py",
// 			env,
// 			body))
// 	{
// 		std::cout << RED
// 				  << "[FAIL] could not start large CGI POST process"
// 				  << RESET
// 				  << std::endl;
// 		return;
// 	}
...
// 		{
// 			std::cout << RED
// 					  << "[FAIL] large CGI POST process did not finish before timeout"
// 					  << RESET
// 					  << std::endl;
// 			return;
// 		}
...
// 	{
// 		std::cout << RED
// 				  << "[FAIL] error while writing large CGI input"
// 				  << RESET
// 				  << std::endl;
// 		return;
// 	}
...
// 	{
// 		std::cout << RED
// 				  << "[FAIL] error while reading large CGI output"
// 				  << RESET
// 				  << std::endl;
// 		return;
// 	}
...
// 	{
// 		std::cout << GREEN
// 				  << "[OK] large CGI POST process finished"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] large CGI POST process did not finish"
// 				  << RESET
// 				  << std::endl;
// 	}
...
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI input required multiple writeInput() calls"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI input was transmitted in a single writeInput() call"
// 				  << RESET
// 				  << std::endl;
// 	}
...
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI stdin closed after large body transmission"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI stdin is still open after large body transmission"
// 				  << RESET
// 				  << std::endl;
// 	}
...
// 	std::string	expectedLength = "Length: " + contentLength.str();

// 	if (output.find(expectedLength) != std::string::npos)
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI received complete body length"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI received incorrect body length"
// 				  << RESET
// 				  << std::endl;
// 	}

// 	if (output.find("Integrity: OK") != std::string::npos)
// 	{
// 		std::cout << GREEN
// 				  << "[OK] CGI received large body without corruption"
// 				  << RESET
// 				  << std::endl;
// 	}
// 	else
// 	{
// 		std::cout << RED
// 				  << "[FAIL] CGI received corrupted large body"
// 				  << RESET
// 				  << std::endl;
// 	}

// 	if (output.find(expectedLength) == std::string::npos
// 		|| output.find("Integrity: OK") == std::string::npos)
// 	{
// 		std::cout << "----- CGI output -----" << std::endl;
// 		std::cout << output;
// 		std::cout << "----------------------" << std::endl;
